...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" <?php if(isset($_SESSION['username']) && $utenteAmministratore){   ?>  href="amministratore\gestioneUtenti.php"  <?php } ?> >ciao <?php echo isset($_SESSION["username"]) ? $_SESSION["username"] : "unknown"; ?> </a>
